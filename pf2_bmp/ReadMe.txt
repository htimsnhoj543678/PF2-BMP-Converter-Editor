...
2. in pf2_bmp_editor.py, a .bmp file can be opened and drawn on. Currently this can only be used to edit the 3rd byte (option 3) aka the player in/out of bounds map
